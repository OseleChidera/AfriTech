...
const MainHome = () => {
  ...
  return (
    ...
    <div className="flex w-[90%] justify-between max-w-[90%] mx-auto border border-red-600 items-center">
        <div className="">
        ...
        <div className="flex justify-between items-center w-fit max-w-md   border border-red-700 gap-3">
          {showInput && (<input type="text" id='searchbar' className='p-2 rounded-sm' />)}
